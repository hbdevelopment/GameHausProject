...
//        onSaved: (value) => _email = value.trim(),
  ...
  void _signIn(email, password) async {
    ...
    try {
      ...
      print('Fail Signed in: $e');
      _showDialog(context, "Sign In Fail", e.message);
    }
  }
  ...
  void _sendResetPasswordLink() async{
    ...
    Navigator.of(context).pop();
    _showDialog(context, "Reset Password", "A link to rest your password has been sent to your email.");
  }
}